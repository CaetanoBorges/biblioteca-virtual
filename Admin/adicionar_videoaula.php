...
<?php 
        ...
        <div style="width:45%;display:inline-block;"> 
               ...
               <style>
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" class="form-control" name="descricao" required style="height:100px">uygeyufg yuryuguyuyre uturey
                    e rjterj tgeriutg uiergt euirgtueirg tueirt ie guiert ergt uiegtuie grutig eruiuirgtu iegtu ietuiegtuiegriugerui geuirt 
                    e riutgheriueuirteuirtiue gtuieguiegtuie uieg iueui eiru g iuer ieurg</textarea>
                </div>
                <br>
        ...
        <div style="width:35%;float:right;"> 
            <div class="form-group">
                <label for="exampleInputEmail1">Inserir arquivo</label>
                <input type="file" name="video" class="form-control" id="exampleInputEmail1" required>
            </div>
        <br>
        <button type="submit" class="btn-principal rv-btn-submit" >ADICIONAR VIDEO</button>
        <br>
        </form>
...
$(document).ready(function(){
    ...
    $("#uploadForm").on('submit', function(e){
        ...
        $.ajax({
            ...
            type: 'POST',
            url: 'Classes/Video/adicionar.php',
